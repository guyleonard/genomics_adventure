...
The 8th column shows the type of entry that was hit in the pfam database. Let's take a look at Pfam domain "SLT" (accession number PF01464.23). Pfam searches are now carried out on the [InterPro](https://www.ebi.ac.uk/interpro/) website, so head there and enter the accession number in the search box.
